...
public class BoardWebViewActivity extends Activity {
    private static final String TAG = "TableLaughs";
    private static final String TABLE_LAUGHS_APP_ID = "table-laughs";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BoardNativePlugin.setAppId(TABLE_LAUGHS_APP_ID);
